...
- stable entity 创建必须同步写入其对应的已确认 Alias projection，但不隐含 Rule、automation policy、Case Log 或 final transaction outcome 写入；accountant 只确认分类、未明确确认 identity 时，不创建 stable entity。
