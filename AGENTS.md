...
- `缺口地图.md` 负责记录当前 Entity 圈 L2 / L3 / L4 / seam 缺口状态；它是接缝与未冻结边界的索引，不替代 `L2_proposals/` 或正式 `BK_Copilot/` 草案。
...
- `缺口地图.md`：查看 Entity 圈当前 L2 / L3 / L4 / seam 缺口和圈外依赖；不替代正式草案或 L2 提案。
...
- 需要查当前 Entity 圈剩余缺口、seam 或圈外依赖：读 `缺口地图.md`。
...
- `缺口地图.md`，仅当 Entity 圈 L2 / L3 / L4 / seam 缺口状态变化时
- 用户要求创建的新审计报告或聚焦审计笔记
...
- Entity 圈缺口、seam 或圈外依赖状态变化后，更新 `缺口地图.md`。
- 不再维护单独的决策文档。
